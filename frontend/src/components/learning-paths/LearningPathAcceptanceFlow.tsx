                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-bold text-orange-600 capitalize">
                        {learningPath.difficulty_adjustment === 'easy' ? 'Kolay' :
                         learningPath.difficulty_adjustment === 'balanced' ? 'Dengeli' : 'Zorlu'}
                      </p>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        {milestone.assessment_criteria.length > 0 && (
                          <div>
                            <h5 className="text-sm font-medium text-gray-700 mb-2">Başarı Kriterleri:</h5>
                            <ul className="space-y-1">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Örnek: "Akşamları çalışmayı tercih ederim" veya "Video içeriklere öncelik vermek istiyorum"
                </p>
              </div>
              ...
              <Card className="p-4">
                <label className="flex items-start space-x-3 cursor-pointer">
                  ...
                  <span className="text-sm">
                    Öğrenme planını inceledim ve {learningPath.duration_weeks} haftalık 
                    bu programa başlamaya hazırım.
                  </span>
                </label>
              </Card>
            </div>
