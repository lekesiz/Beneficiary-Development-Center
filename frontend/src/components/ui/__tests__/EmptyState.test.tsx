...
describe('EmptyState', () => {
  ...
  it('renders without action button', () => {
    render(<EmptyState icon={Users} title="No Users" description="No users have been added yet" />);
  ...
  it('renders the icon with correct styling', () => {
    render(<EmptyState icon={FileText} title="Test" description="Test description" />);
  ...
  it('centers text content', () => {
    render(
      <EmptyState icon={FileText} title="Centered Title" description="This should be centered" />
    );
  ...
  it('displays icon inside a styled container', () => {
    const { container } = render(<EmptyState icon={FileText} title="Test" description="Test" />);
