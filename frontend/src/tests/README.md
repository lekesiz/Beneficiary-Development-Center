...
1. **Use custom render**: Always use the custom render function that includes providers
2. **Mock at the network level**: Use MSW for API mocking instead of module mocks
