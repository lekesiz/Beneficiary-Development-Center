    ...
    return (
      <div className="p-6 max-w-7xl mx-auto">
        <div className="text-center py-12">
          ...
          <Button onClick={() => navigate('/coach/dashboard')} className="mt-4">
            Listeye Dön
          </Button>
        </div>
      </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <Badge
                ...
                className="mt-1"
              >
                {profile.development_scores.risk_score === 'High'
                  ? 'Yüksek'
                  : profile.development_scores.risk_score === 'Medium'
                  ? 'Orta'
                  : 'Düşük'}
              </Badge>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <p className="text-sm text-gray-600 mb-2">
                    Programlar ({profile.enrollments.programs.length})
                  </p>
                ...
                <div>
                  <p className="text-sm text-gray-600 mb-2">
                    Kurslar ({profile.enrollments.courses.length})
                  </p>
