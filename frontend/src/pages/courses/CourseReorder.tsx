...
export const CourseReorder: React.FC = () => {
  ...
  if (!canReorder) {
    return (
      <Card className="p-6">
        <div className="text-center text-red-600">Bu sayfaya erişim yetkiniz bulunmamaktadır.</div>
      </Card>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          <Button variant="ghost" size="sm" onClick={() => navigate(`/programs/${programId}`)}>
        ...
        <div className="flex items-center space-x-2">
          ...
          <Button onClick={handleSave} disabled={!hasChanges || reorderCourse.isPending}>
      ...
      <Card className="p-4 bg-blue-50 border-blue-200">
        <div className="flex items-center space-x-2 text-blue-700">
          <span className="text-sm">
            💡 Kursları sürükleyerek istediğiniz sıraya getirin. Değişikliklerinizi kaydetmeyi
            unutmayın.
          </span>
        </div>
      </Card>
      ...
      {/* Course List */}
      <Card className="p-6">
        <h3 className="text-lg font-semibold mb-4">Kurslar ({courses.length})</h3>

        {courses.length === 0 ? (
          <div className="text-center py-12 text-gray-500">Bu programa henüz kurs eklenmemiş.</div>
        ) : (
          <DragDropList
            items={dragDropItems}
        ...
        <Card className="p-4 bg-yellow-50 border-yellow-200">
          <div className="flex items-center justify-between">
            ...
            <div className="flex space-x-2">
              ...
              <Button size="sm" onClick={handleSave} disabled={reorderCourse.isPending}>
                Kaydet
              </Button>
            </div>
          </div>
