      ...
      <div className="container mx-auto py-6">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mt-2">
            The beneficiary you're looking for doesn't exist or you don't have permission to view it.
          </p>
          <Button
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <InfoItem
                    ...
                    value={beneficiary.employment_status ? 
                      ...
                      beneficiary.employment_status.replace(/_/g, ' ').slice(1) : null
                    }
                  />
                  <InfoItem
                    icon={Briefcase}
                  ...
                  <InfoItem
                    ...
                    value={beneficiary.years_of_experience ? 
                      `${beneficiary.years_of_experience} years` : null
                    }
                  />
                </div>
              </CardContent>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <InfoItem
                      ...
                      value={beneficiary.education_level ?
                        beneficiary.education_level.replace(/_/g, ' ').charAt(0).toUpperCase() + 
                        beneficiary.education_level.replace(/_/g, ' ').slice(1) : null
                      }
                    />
                    <InfoItem
                      icon={GraduationCap}
