...
const BeneficiaryList = lazy(
  () => import('@/pages/beneficiaries/BeneficiaryList')
);
const BeneficiaryDetail = lazy(
  () => import('@/pages/beneficiaries/BeneficiaryDetail')
);
const BeneficiaryForm = lazy(
  () => import('@/pages/beneficiaries/BeneficiaryForm')
);
...
const CourseSessionForm = lazy(
  () => import('@/pages/courses/CourseSessionForm')
);
...
const TakeEvaluationAdaptive = lazy(
  () => import('@/pages/evaluations/TakeEvaluationAdaptive')
);
...
const MyDevelopmentReport = lazy(
  () => import('@/pages/reports/MyDevelopmentReport')
);
      ...
      <Routes>
        ...
        >
          ...
          <Route
            ...
            element={<CourseSessionForm />}
          />

          {/* Program course management */}
          <Route
            path="/programs/:programId/courses/reorder"
            element={<CourseReorder />}
          />
          ...
          <Route
            path="/evaluations/:id/take-adaptive"
            element={<TakeEvaluationAdaptive />}
          />
          <Route
            path="/evaluations/:id/results/:attemptId"
