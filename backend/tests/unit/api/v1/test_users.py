...
class TestUserPreferences:
    ...
    def test_update_user_preferences_success(self, client, auth_headers, db_session):
        ...
        with (
            patch("app.extensions.db.session.get") as mock_get,
            ...
            mock_log.assert_called_once_with(
                "update_preferences", user_id=1, tenant_id=1, email="test@example.com", preferences_type="notifications"
            )
    ...
    def test_update_user_preferences_user_not_found(self, client, auth_headers):
        ...
        with patch("app.extensions.db.session.get") as mock_get:
            ...
            request_data = {"notifications": {"email": {"new_message": True}, "in_app": {"new_message": True}}}
