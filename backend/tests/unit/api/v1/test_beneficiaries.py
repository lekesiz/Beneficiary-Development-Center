...
class TestBeneficiaryEndpoints:
    ...
    def test_get_beneficiaries_sorting(self, client, auth_headers, multiple_beneficiaries):
        ...
        response = client.get("/api/v1/beneficiaries?sort_by=first_name&sort_order=asc", headers=auth_headers)
        data = json.loads(response.data)
    ...
    def test_get_beneficiary_by_uuid_success(self, client, auth_headers, test_beneficiary):
        ...
        response = client.get(f"/api/v1/beneficiaries/uuid/{test_beneficiary.uuid}", headers=auth_headers)
    ...
    def test_create_beneficiary_success(self, client, auth_headers):
        ...
        response = client.post("/api/v1/beneficiaries", headers=auth_headers, json=payload)
    ...
    def test_create_beneficiary_missing_required(self, client, auth_headers):
        ...
        payload = {"email": "missing.name@test.com"}
    ...
    def test_create_beneficiary_duplicate_email(self, client, auth_headers, test_beneficiary):
        ...
        payload = {"first_name": "Duplicate", "last_name": "User", "email": test_beneficiary.email}
    ...
    def test_create_beneficiary_invalid_enum(self, client, auth_headers):
        ...
        payload = {"first_name": "Test", "last_name": "User", "employment_status": "invalid_status"}
    ...
    def test_create_beneficiary_student_denied(self, client, student_auth_headers):
        ...
        response = client.post("/api/v1/beneficiaries", headers=student_auth_headers, json=payload)
    ...
    def test_update_beneficiary_success(self, client, auth_headers, test_beneficiary):
        ...
        payload = {"first_name": "Updated", "email": "updated@test.com", "employment_status": "self_employed"}

        response = client.put(f"/api/v1/beneficiaries/{test_beneficiary.id}", headers=auth_headers, json=payload)
    ...
    def test_update_beneficiary_not_found(self, client, auth_headers):
        ...
        response = client.put("/api/v1/beneficiaries/999999", headers=auth_headers, json=payload)
    ...
    def test_delete_beneficiary_success(self, client, auth_headers, test_beneficiary):
        ...
        response = client.delete(f"/api/v1/beneficiaries/{test_beneficiary.id}", headers=auth_headers)
    ...
    def test_delete_beneficiary_trainer_denied(self, client, trainer_auth_headers, test_beneficiary):
        ...
        response = client.delete(f"/api/v1/beneficiaries/{test_beneficiary.id}", headers=trainer_auth_headers)
    ...
    def test_add_note_success(self, client, auth_headers, test_beneficiary):
        ...
        response = client.post(f"/api/v1/beneficiaries/{test_beneficiary.id}/notes", headers=auth_headers, json=payload)
    ...
    def test_add_note_missing_text(self, client, auth_headers, test_beneficiary):
        ...
        response = client.post(f"/api/v1/beneficiaries/{test_beneficiary.id}/notes", headers=auth_headers, json={})
    ...
    def test_add_tag_success(self, client, auth_headers, test_beneficiary):
        ...
        response = client.post(f"/api/v1/beneficiaries/{test_beneficiary.id}/tags", headers=auth_headers, json=payload)
    ...
    def test_remove_tag_success(self, client, auth_headers, test_beneficiary):
        ...
        # First add a tag
        client.post(
            f"/api/v1/beneficiaries/{test_beneficiary.id}/tags", headers=auth_headers, json={"tag": "tag-to-remove"}
        )

        # Then remove it
        response = client.delete(
            f"/api/v1/beneficiaries/{test_beneficiary.id}/tags/tag-to-remove", headers=auth_headers
        )
    ...
    def test_assign_trainer_success(self, client, auth_headers, test_beneficiary, trainer_user):
        ...
        response = client.post(
            f"/api/v1/beneficiaries/{test_beneficiary.id}/assign-trainer", headers=auth_headers, json=payload
        )
    ...
    def test_assign_trainer_trainer_denied(self, client, trainer_auth_headers, test_beneficiary):
        ...
        response = client.post(
            f"/api/v1/beneficiaries/{test_beneficiary.id}/assign-trainer", headers=trainer_auth_headers, json=payload
        )
