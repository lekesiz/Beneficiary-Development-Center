...
class TestProgramsAPI:
    ...
    def test_get_programs_with_filters(self):
        ...
        response = self.client.get(
            "/api/v1/programs?status=published", headers={"Authorization": f"Bearer {self.admin_token}"}
        )
        ...
        # Filter by type
        response = self.client.get(
            "/api/v1/programs?type=workshop", headers={"Authorization": f"Bearer {self.manager_token}"}
        )
        ...
        # Search
        response = self.client.get(
            "/api/v1/programs?search=Python", headers={"Authorization": f"Bearer {self.staff_token}"}
        )
    ...
    def test_get_programs_pagination(self):
        ...
        response = self.client.get(
            "/api/v1/programs?page=1&per_page=2", headers={"Authorization": f"Bearer {self.admin_token}"}
        )
    ...
    def test_get_program_by_id(self):
        ...
        response = self.client.get(
            f"/api/v1/programs/{self.program1.id}", headers={"Authorization": f"Bearer {self.admin_token}"}
        )
    ...
    def test_get_program_not_found(self):
        ...
        response = self.client.get("/api/v1/programs/999", headers={"Authorization": f"Bearer {self.admin_token}"})
    ...
    def test_create_program_admin(self):
        ...
        response = self.client.post(
            "/api/v1/programs", json=program_data, headers={"Authorization": f"Bearer {self.admin_token}"}
        )
    ...
    def test_create_program_manager(self):
        ...
        response = self.client.post(
            "/api/v1/programs", json=program_data, headers={"Authorization": f"Bearer {self.manager_token}"}
        )
    ...
    def test_create_program_forbidden(self):
        ...
        response = self.client.post(
            "/api/v1/programs", json=program_data, headers={"Authorization": f"Bearer {self.staff_token}"}
        )
    ...
    def test_delete_program_admin(self):
        ...
        response = self.client.delete(
            f"/api/v1/programs/{program.id}", headers={"Authorization": f"Bearer {self.admin_token}"}
        )
    ...
    def test_get_program_statistics(self):
        ...
        response = self.client.get(
            "/api/v1/programs/statistics", headers={"Authorization": f"Bearer {self.admin_token}"}
        )
    ...
    def test_get_statistics_forbidden(self):
        ...
        response = self.client.get(
            "/api/v1/programs/statistics", headers={"Authorization": f"Bearer {self.staff_token}"}
        )
