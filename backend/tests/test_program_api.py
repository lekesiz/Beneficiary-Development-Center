...
class TestProgramAPI:
    ...
    def test_update_program_success(self, client, admin_headers, db_session):
        ...
        update_data = {"title": "Updated Title", "description": "Updated description", "max_participants": 100}
    ...
    def test_update_program_status_success(self, client, admin_headers, db_session):
        ...
        response = client.put(
            f"/api/v1/programs/{program.id}/status", json={"status": "published"}, headers=admin_headers
        )
    ...
    def test_update_program_status_invalid_transition(self, client, admin_headers, db_session):
        ...
        response = client.put(f"/api/v1/programs/{program.id}/status", json={"status": "draft"}, headers=admin_headers)
