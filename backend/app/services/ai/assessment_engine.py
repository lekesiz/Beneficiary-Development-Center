...
class AdaptiveAssessmentEngine:
    ...
    def select_next_question(self, 
                           theta: float, 
                           available_questions: List[QuestionParameters],
                           answered_questions: List[int]) -> Optional[QuestionParameters]:
        """
        ...
        information_values = [
            (q, self.calculate_information(theta, q))
            for q in candidates
        ]
    ...
    def generate_performance_report(self, ability: StudentAbility, 
                                  responses: List[Tuple[QuestionParameters, bool]]) -> Dict:
        """
    ...
    def predict_success_probability(self, ability: StudentAbility, 
