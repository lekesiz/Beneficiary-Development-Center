...
def handle_not_found_error(e: NotFoundError) -> Tuple[Dict[str, Any], int]:
    ...
    return ErrorResponse.create(
        error="NotFoundError", message=str(e) or "Resource not found", status_code=404, error_code="RESOURCE_NOT_FOUND"
    )
...
def handle_bad_request_error(e: BadRequestError) -> Tuple[Dict[str, Any], int]:
    ...
    return ErrorResponse.create(
        error="BadRequestError", message=str(e) or "Bad request", status_code=400, error_code="BAD_REQUEST"
    )
...
def handle_forbidden_error(e: ForbiddenError) -> Tuple[Dict[str, Any], int]:
    ...
    return ErrorResponse.create(
        error="ForbiddenError", message=str(e) or "Access forbidden", status_code=403, error_code="ACCESS_FORBIDDEN"
    )
...
def handle_unauthorized_error(e: UnauthorizedError) -> Tuple[Dict[str, Any], int]:
    ...
    return ErrorResponse.create(
        error="UnauthorizedError", message=str(e) or "Unauthorized access", status_code=401, error_code="UNAUTHORIZED"
    )
...
def handle_conflict_error(e: ConflictError) -> Tuple[Dict[str, Any], int]:
    ...
    return ErrorResponse.create(
        error="ConflictError", message=str(e) or "Resource conflict", status_code=409, error_code="RESOURCE_CONFLICT"
    )
...
def handle_jwt_invalid_error(e: InvalidTokenError) -> Tuple[Dict[str, Any], int]:
    ...
    return ErrorResponse.create(
        error="InvalidTokenError", message="Invalid authentication token", status_code=401, error_code="INVALID_TOKEN"
    )
...
def register_error_handlers(app):
    ...
    def not_found(e):
        return ErrorResponse.create(
            error="NotFound", message="The requested resource was not found", status_code=404, error_code="NOT_FOUND"
        )
