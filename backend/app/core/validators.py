...
class ValidationSchemas:
    ...
    LOGIN_SCHEMA = {
        ...
        "tenant_id": {"type": int, "required": True, "min_value": 1},
    }

    REGISTER_SCHEMA = {
        "email": {"type": str, "required": True, "validator": Validator.validate_email},
        "password": {"type": str, "required": True, "validator": lambda p: Validator.validate_password(p)[0]},
        "first_name": {"type": str, "required": True, "min_length": 2, "max_length": 50},
        "last_name": {"type": str, "required": True, "min_length": 2, "max_length": 50},
        "tenant_id": {"type": int, "required": True, "min_value": 1},
    }
    ...
    BENEFICIARY_CREATE_SCHEMA = {
        "first_name": {"type": str, "required": True, "min_length": 2, "max_length": 50},
        "last_name": {"type": str, "required": True, "min_length": 2, "max_length": 50},
        "email": {"type": str, "required": False, "validator": Validator.validate_email},
        "phone": {"type": str, "required": False, "validator": Validator.validate_phone},
        "date_of_birth": {"type": str, "required": False, "validator": Validator.validate_date},
        "status": {"type": str, "required": False, "choices": ["active", "inactive", "completed", "suspended"]},
        "employment_status": {
            "type": str,
            "required": False,
