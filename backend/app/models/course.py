...
class Course(TenantBaseModel):
    ...
    def get_participant_count(self):
        ...
        return len([e for e in self.program.enrollments if e.status in ["enrolled", "in_progress"]])
    ...
    def get_average_score(self):
        ...
        scores = [p.assessment_score for p in self.progress_records if p.assessment_score is not None]
    ...
    def add_session(self, session_data):
        ...
        session = CourseSession(course_id=self.id, tenant_id=self.tenant_id, **session_data)
