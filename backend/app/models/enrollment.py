...
class Enrollment(TenantBaseModel):
    ...
    creator = relationship("User", foreign_keys=[created_by], back_populates="created_enrollments")
    ...
    def calculate_progress(self):
        ...
        completed_courses = sum(1 for progress in self.course_progress if progress.is_completed)
    ...
    def calculate_attendance(self):
        ...
        attended_sessions = sum(1 for record in self.attendance_records if record.is_present)
    ...
    def get_certificate_eligibility(self):
        ...
        failed_assessments = [
            progress
            for progress in self.course_progress
