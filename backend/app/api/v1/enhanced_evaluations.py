...
from app.models.evaluation import Evaluation, EvaluationStatus, Question, QuestionType, EvaluationAttempt as Attempt, AttemptStatus
...
def update_evaluation(evaluation_id: int):
    ...
    try:
        ...
        return ErrorResponse.create(
            ...
            message=str(e),
            status_code=400,
            error_code="INVALID_EVALUATION_STATE"
        )
    except Exception as e:
...
def start_attempt(evaluation_id: int):
    ...
    try:
        ...
        return ErrorResponse.create(
            ...
            message=str(e),
            status_code=400,
            error_code="CANNOT_START_ATTEMPT"
        )
    except Exception as e:
...
def submit_attempt(evaluation_id: int, attempt_id: int):
    ...
    try:
        ...
        return ErrorResponse.create(
            ...
            message=str(e),
            status_code=400,
            error_code="INVALID_ATTEMPT_STATE"
        )
    except Exception as e:
...
def duplicate_evaluation(evaluation_id: int):
    ...
    try:
        ...
        return ErrorResponse.create(
            error="InternalError",
            message="Failed to duplicate evaluation",
            status_code=500
        )
    ...
    try:
        ...
        if export_format == 'json':
            ...
            return Response(
                ...
                mimetype='text/csv',
                headers={
                    'Content-Disposition': f'attachment; filename=evaluation_{evaluation.id}_questions.csv'
                }
            )
        ...
        return ErrorResponse.create(
            error="InternalError",
            message="Failed to export evaluation",
            status_code=500
        )
...
def batch_grade_attempts():
    ...
    try:
        ...
        return ErrorResponse.create(
            error="InternalError",
            message="Failed to batch grade attempts",
            status_code=500
        )