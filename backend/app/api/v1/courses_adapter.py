...
def get_all_courses():
    ...
    try:
        ...
        # Build query
        query = db.session.query(Course).filter_by(tenant_id=tenant_id, deleted_at=None)
...
def get_course_by_id(course_id):
    ...
    try:
        ...
        # Get the course
        course = db.session.query(Course).filter_by(id=course_id, tenant_id=tenant_id, deleted_at=None).first()
            ...
            for session in course.sessions:
                session_data = {
                    ...
                    "session_date": (
                        ...
                        if not hasattr(session.session_date, "isoformat")
...
def create_course():
    ...
    try:
        ...
        program = db.session.query(Program).filter_by(id=program_id, tenant_id=tenant_id, deleted_at=None).first()
        ...
        existing_courses = (
            db.session.query(Course).filter_by(program_id=program_id, tenant_id=tenant_id, deleted_at=None).count()
        )
