...
def get_beneficiary(beneficiary_id):
    ...
    try:
        ...
        return jsonify({"beneficiary": beneficiary.to_dict(include_related=True)}), 200
...
def add_note(beneficiary_id):
    ...
    try:
        ...
        return (
            jsonify({"message": "Note added successfully", "beneficiary": beneficiary.to_dict(include_related=True)}),
            200,
        )
...
def add_tag(beneficiary_id):
    ...
    try:
        ...
        return (
            jsonify({"message": "Tag added successfully", "beneficiary": beneficiary.to_dict(include_related=True)}),
            200,
        )
...
def remove_tag(beneficiary_id, tag):
    ...
    try:
        ...
        return (
            jsonify({"message": "Tag removed successfully", "beneficiary": beneficiary.to_dict(include_related=True)}),
            200,
        )
...
def assign_trainer(beneficiary_id):
    ...
    try:
        ...
        return (
            jsonify(
                {"message": "Trainer assigned successfully", "beneficiary": beneficiary.to_dict(include_related=True)}
            ),
            200,
        )
