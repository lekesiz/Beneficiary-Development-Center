...
class PhoneSchema(BaseSchema):
    ...
    phone = fields.String(
        ...
        error_messages={
            "invalid": "Phone number must be between 10 and 20 characters"
        }
    )
...
class MoneySchema(BaseSchema):
    ...
    amount = fields.Decimal(
        ...
        error_messages={
            "invalid": "Amount must be a valid decimal with up to 2 decimal places"
        }
    )
...
class FileUploadSchema(BaseSchema):
    ...
    file_size = fields.Integer(
        validate=validate.Range(max=10485760),  # 10MB max
        error_messages={
            "invalid": "File size must not exceed 10MB"
        }
    )
...
class BatchOperationSchema(BaseSchema):
    ...
    confirm = fields.Boolean(
        missing=False,
        error_messages={
            "invalid": "Confirm must be a boolean value"
        }
    )
...
class SearchSchema(BaseSchema):
    ...
    query = fields.String(
        ...
        error_messages={
            "invalid": "Search query must be between 2 and 100 characters"
        }
    )
    search_fields = fields.List(
        ...
        error_messages={
            "invalid": "Cannot search more than 10 fields at once"
        }
    )
