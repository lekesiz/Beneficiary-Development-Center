...
class BeneficiaryCreateSchema(Schema):
    ...
    education_level = fields.Str(
        ...
        validate=validate.OneOf(
            ["no_diploma", "primary", "secondary", "high_school", "bachelor", "master", "doctorate", "other"]
        ),
    )
    ...
    status = fields.Str(
        required=False, default="active", validate=validate.OneOf(["active", "inactive", "completed", "suspended"])
    )
...
class BeneficiaryListSchema(Schema):
    ...
    status = fields.Str(required=False, validate=validate.OneOf(["active", "inactive", "completed", "suspended"]))
    ...
    sort_order = fields.Str(required=False, default="desc", validate=validate.OneOf(["asc", "desc"]))
